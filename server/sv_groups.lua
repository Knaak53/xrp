...
AddEventHandler("xrp:addGroup", function(group, inherit, aceGroup)
	...
	if(type(group) ~= "string")then
		log('XRP_ERROR: There seems to be an issue while creating a new group, please make sure that you entered a correct "group" as "string"')
		print('XRP_ERROR: There seems to be an issue while creating a new group, please make sure that you entered a correct "group" as "string"')
	end

	if(type(inherit) ~= "string")then
		log('XRP_ERROR: There seems to be an issue while creating a new group, please make sure that you entered a correct "inherit" as "string"')
		print('XRP_ERROR: There seems to be an issue while creating a new group, please make sure that you entered a correct "inherit" as "string"')
	end
...
AddEventHandler("xrp:canGroupTarget", function(group, targetGroup, cb)
	canGroupTarget(group, targetGroup, cb)
end)

-- Get all groups
AddEventHandler("xrp:getAllGroups", function(cb)
	cb(groups)
end)